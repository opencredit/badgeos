...
class BadgeOS_Points_Test extends WP_UnitTestCase {
	...
	public function test_badgeos_get_users_points() {
		...
		badgeos_utilities::update_user_meta( $user_id, '_badgeos_points', $actual_points );
	...
	public function test_badgeos_update_users_points_increase() {
		...
		$user_id = $this->factory->user->create();
		badgeos_utilities::update_user_meta( $user_id, '_badgeos_points', $starting_points );
	...
	public function test_badgeos_award_user_points() {
		...
		badgeos_utilities::update_post_meta( $achievement_id, '_badgeos_points', $achievement_points );
