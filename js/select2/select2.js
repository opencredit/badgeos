...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatMatches: function (matches) { return matches + badgeos_select_translations.matches; },
        formatNoMatches: function () { return badgeos_select_translations.no_matches; },
        formatInputTooShort: function (input, min) { var n = min - input.length; return badgeos_select_translations.too_short1 + n + badgeos_select_translations.too_short2 + (n == 1? "" : badgeos_select_translations.plural_suffix); },
        formatInputTooLong: function (input, max) { var n = input.length - max; return badgeos_select_translations.too_long1 + n + badgeos_select_translations.too_long2 + (n == 1? "" : badgeos_select_translations.plural_suffix); },
        formatSelectionTooBig: function (limit) { return badgeos_select_translations.too_big1 + limit + badgeos_select_translations.too_big2 + (limit == 1 ? "" : badgeos_select_translations.plural_suffix); },
        formatLoadMore: function (pageNumber) { return badgeos_select_translations.loading; },
        formatSearching: function () { return badgeos_select_translations.searching; },
