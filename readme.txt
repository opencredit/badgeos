=== BadgeOS ===
Contributors: webdevstudios, williamsba1, rzen, jtsternberg, ryanduff
...
Easily create badges and set up the steps and achievements users take to earn them. Badges are Mozilla OBI compatible and sharable via Credly.

== Description ==

[BadgeOS](http://badgeos.org "BadgeOS")™ turns your WordPress site into an. With BadgeOS, your site’s users take action, demonstrate achievement, and earn badges. Easily define the achievements, organize the badge requirements any way you like, and choose from and combine a range of assessment options to determine whether each task or requirement has been achieved.

Create badges and set up the achievements to earn them. Badges are Mozilla OBI compatible and sharable via Credly, the free web service for recognizing and displaying lifelong achievement.
...
*   Create badges in WordPress, and then issue them from your phone!  
...
* BadgeOS works with just about any WordPress theme. 
...
[Credly](https://credly.com/ "Credly web site") is the universal way to recognize, store and share life’s achievements. We’ve integrated Credly into BadgeOS because it’s downright the easiest, most fun way to collect evidence all your achievements in one place and then share them out when and where it matters most. There are a rapidly growing number of platforms and apps that are using the Credly "Open Credit" API to enable sharable badges; the BadgeOS WordPress integration is just one great example! Visit us [Credly.com](https://credly.com "Credly on the Web") to learn more or [contact](https://credly.com/contact "Contact us") us for guidance with using the Open Credit API in your own projects or applications.
