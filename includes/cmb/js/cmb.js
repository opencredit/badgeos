...
jQuery(document).ready(function ($) {
	...
	/**
	 * The code below modifies the "insert media" behavior.
	 *
	 * It has been commented out because WooTheme's Canvas theme
	 * causes conflict because they duplicate this code. We currently
	 * don't use it for BadgeOS in any way, so there is no harm
	 * in removing it for now. -BR
	 */
