	...
	<li class="step-row step-<?php echo $step_id; ?>" data-step-id="<?php echo $step_id; ?>">
        ...
        <div id="badgeos_achievements_step_dynamic_section_<?php echo $key;?>" style="display:inline-block">
            <select id="badgeos_achievements_step_ddl_dynamic_<?php echo $key;?>" data-trigger="<?php echo $key;?>" class="badgeos_achievements_step_fields badgeos_achievements_step_ddl_dynamic" name="badgeos_achievements_step_ddl_dynamic_<?php echo $key;?>">
				...
				<input type="number" size="5" min="1" placeholder="<?php _e( 'X Users', 'badgeos' ); ?>" value="<?php esc_attr_e( intval( $requirements['x_number_of_users'] ) > 0 ? intval( $requirements['x_number_of_users'] ): "" ); ?>" class="badgeos-x-number-of-users badgeos-x-number-of-users-<?php echo $step_id; ?>">
				...
				<input type="number" size="5" min="1" placeholder="<?php _e( 'days', 'badgeos' ); ?>" value="<?php esc_attr_e( intval( $requirements['num_of_days_login'] ) > 0 ? intval( $requirements['num_of_days_login'] ): "1" ); ?>" class="badgeos-num-of-days-login badgeos-num-of-days-login-<?php echo $step_id; ?>">
