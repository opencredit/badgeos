 ...
 */ 
registerBlockType( 'bos/badgeos-submission-form-block', {
	// Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
	title: __( 'Submission Form - block' ), // Block title.
	...
	edit: ( props ) => { 
		...
		return [
			el("div", {
				className: "bos-editor-container",
				style: {textAlign: "center"}
			  },
			  el( ServerSideRender, {
				block: 'bos/badgeos-submission-form-block',
                ...
                <PanelBody title={ __( 'Achievement ID', 'badgeos' ) } className="bos-block-inspector">
                    <PanelRow>
                        <label htmlFor="bos-block-roles" className="bos-block-inspector__label">
                            { __( 'Render a single submission.', 'badgeos' ) }
                        </label>
                    </PanelRow>
                    <PanelRow> 
						<Select
