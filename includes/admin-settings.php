...
function badgeos_help_support_page() { ?>
	<div class="wrap" >
		...
		<p><?php printf(
			__( 'For support on using BadgeOS or to suggest feature enhancements, visit the %s. The BadgeOS team does perform custom development that extends the BadgeOS platform in some incredibly powerful ways. %s with inquiries. See examples of %s.', 'badgeos' ),
			sprintf(
				'<a href="http://badgeos.org" target="_blank">BadgeOS %s</a>',
				__( 'site', 'badgeos' )
			),
			sprintf(
			...
			sprintf(
				'<a href="%s">%s</a>',
				'http://badgeos.org/about/sample-sites/',
